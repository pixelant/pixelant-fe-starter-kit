...
- Run `grunt small` to start static server [same as `grunt`] plus it generates files for **SMALL** project in folder `small`
- Run `grunt big` to start static server [same as `grunt`] plus it generates files for **BIG** project in folder `big`
